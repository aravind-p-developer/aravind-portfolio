            ...
            <RevealOnScroll key={category.id} delay={categoryIndex * 0.05}>
              <div className="tech-category-panel">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-label-md text-label-md text-white uppercase tracking-wider">
                    {category.label}
                  </h3>
                </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 md:gap-4">
                    {coreItems.map((techName, index) => {
                      ...
                      return (
                        ...
                        >
                          <Card
                            className="!p-4 flex flex-col items-center justify-center gap-2.5 h-full spotlight-card cursor-default group"
                          ...
                          >
                            ...
                            <span className="font-label-md text-white text-xs sm:text-sm text-center leading-snug">
                              {techName}
                            </span>
                          </Card>
                        </motion.div>
                    ...
                    {secondaryItems.map((techName, index) => {
                      return (
                        <motion.div
                          ...
                          className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/[0.02] border border-white/5 hover:border-brand-blue/30 hover:bg-brand-blue/5 hover:text-white text-on-surface-variant transition-all duration-300 cursor-default group"
                        >
                          ...
                          <span
                            className="font-label-sm text-xs sm:text-sm truncate"
                            title={techName}
                          >
                            {techName}
                          </span>
